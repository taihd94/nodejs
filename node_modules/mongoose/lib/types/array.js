...
MongooseArray.mixin = {
   ...
   *
   * The first pull call will result in a atomic operation on the mongodb, if pull is called repeatedly without saving the document, a $set operation is used on the complete array instead, overwriting possible changes that happened on the mongodb in the meantime.
   *
   * @param {any} [args...]
