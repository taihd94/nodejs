...
/**
 * @fileOverview GridFS is a tool for MongoDB to store files to the mongodb.
 * Because of the restrictions of the object size the mongodb can hold, a
 ...
 *
 * @class
 * @param {Db} db A mongodb instance to interact with.
...
/**
 * Opens the file from the mongodb and initialize this object. Also creates a
...
/**
 * Stores a file from the file system to the GridFS mongodb.
 *
 * @method
...
/**
 * Saves this file to the mongodb. This will overwrite the old entry if it
...
/**
 * Deletes all the chunks of this file in the mongodb.
 *
 * @method
...
/**
 * Deletes all the chunks of this file in the mongodb if mode was set to "w" or
...
/**
 * Checks if a file exists in the mongodb.
 *
 * @method
 * @static
 * @param {Db} db the mongodb to query.
